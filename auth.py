...
class User(Document):
    ...
    gender = StringField(verbose_name=_('gender address'))

    phone_number = StringField(verbose_name=_('phone number address'))
    
    birth_date = DateTimeField(default=datetime_now,
